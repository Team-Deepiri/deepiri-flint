...
pub const skill_name = "fingerprint";
...
pub fn run(ctx: skill.SkillContext, input_json: []const u8) skill.SkillError!skill.SkillResult {
    ...
    o.putString("fingerprint", fp) catch return skill.SkillError.OutOfMemory;
    o.putString("algo", "sha256") catch return skill.SkillError.OutOfMemory;
